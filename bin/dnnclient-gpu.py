...
while True:
    ...
    while True:
        ...
        rcvmsg = adinclientsock.recv(num_raw * 4)

        if(len(rcvmsg) == num_raw * 4) and nbytes == num_raw_bytes:
